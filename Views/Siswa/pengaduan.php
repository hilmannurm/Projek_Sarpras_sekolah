...
<head>
    ...
    <title>Pengaduan Saya - Pengaduan Sarpras</title>
        ...
        <header class="h-20 bg-white border-b border-gray-200
            ...
            <div>
                ...
                <p class="text-sm text-gray-400">
                    Lihat dan pantau seluruh pengaduan yang kamu ajukan.
                </p>
            ...
            <div class="flex items-center justify-between mb-6">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">
                        Semua pengaduan yang telah kamu ajukan.
                    </p>
            ...
            <div class="bg-white border border-gray-200
                ...
                <div class="px-6 py-5 border-b border-gray-200">
                    ...
                    <p class="text-sm text-gray-400 mt-1">
                        Pantau perkembangan setiap pengaduan.
                    </p>
                ...
                <div class="px-6 py-4 border-t border-gray-200
                    ...
                    <p class="text-sm text-gray-500">
                        Menampilkan 1–4 dari 6 pengaduan
                    </p>
